    ...
    <div class="flex flex-col gap-6">
        ...
        >
            <div x-show="!showRecoveryInput">
                <x-auth-header
                    :title="__('Codigo de autenticación')"
                    :description="__('Ingrese el código de autenticación proporcionado por su aplicación de autenticación.')"
                />
            </div>

            <div x-show="showRecoveryInput">
                <x-auth-header
                    :title="__('Codigo de recuperación')"
